...
lstm_pauses = LSTM(16, return_sequences=True, use_cudnn=False)(input_pauses)
lstm_charBurst = LSTM(16, return_sequences=True, use_cudnn=False)(input_charBurst)
lstm_pos = LSTM(16, return_sequences=True, use_cudnn=False)(input_pos)
lstm_pos_start = LSTM(16, return_sequences=True, use_cudnn=False)(input_pos_start)
lstm_pos_end = LSTM(16, return_sequences=True, use_cudnn=False)(input_pos_end)
lstm_frequencies = LSTM(16, return_sequences=True, use_cudnn=False)(input_frequencies)
lstm_frequencies_in_text = LSTM(16, return_sequences=True, use_cudnn=False)(input_frequencies_in_text)
lstm_relative_frequencies = LSTM(16, return_sequences=True, use_cudnn=False)(input_relative_frequencies)
